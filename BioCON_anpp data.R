...
#clean up workspace
rm(list=c('anpp', 'anpp16', 'anppAll', 'anppInitial', 'anppInitialYear', 'anppLast', 'anppLastLong', 'anppLastLongComplete', 'anppMonoAvgWide', 'anppMonoAvg', 'anppPoly',  'anppNoTrt', 'anppSum', 'anppTrt', 'anppTrue16', 'anppTrue16Trt', 'anppTrue16TrtNonzero', 'trt', 'anppSub', 'legume1', 'legume1mean', 'legume4', 'legume4mean', 'legume4to1', 'anppTrtMeans', 'anppRRmean', 'anppRRmeansd', 'anppRRn', 'anppRRsd', 'anppHedgesDaSpp', 'anppHedgesDbSpp', 'anppHedgesDSppci', 'anppHedgesDSppd', 'anppRRmeansdSpp', 'anppRRmeanSpp', 'anppRRnSpp', 'anppRRsdSpp', 'anppTrtMeansSpp'))